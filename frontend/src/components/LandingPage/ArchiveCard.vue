<template>
  <div class="bg-white border rounded-lg p-4 shadow-md cursor-pointer transition hover:shadow-lg mb-3"
    @click="emit('toggle', section, index)">
    <h3 class="text-lg font-semibold text-gray-800">Archive ID: ARCH-{{ id }}</h3>
