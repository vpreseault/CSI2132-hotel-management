<template>
  <div class="bg-white p-4 rounded-lg shadow-md relative">
    ...
    <div class="flex justify-between mt-4">
      <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition" @click="isModalOpen = true">
        Edit Room </button>
      <button class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition" @click="confirmDelete"> Delete
        Room </button>
    </div>
