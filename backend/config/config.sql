...
(1, 'Brandi Stewart', '947 Main St, Boston', 'SIN', '328-48-9432', 'Manager'),
(1, 'Gail Morrow', '717 Main St, Boston', 'SSN', '119-72-7960', 'Employee'),
(1, 'Jeremy Patel', '882 Main St, Boston', 'SIN', '777-64-7061', 'Employee'),
(2, 'Bryan Smith', '932 Main St, Montreal', 'SSN', '720-54-9106', 'Manager'),
(2, 'Lawrence Chang', '665 Main St, Montreal', 'SIN', '246-78-2837', 'Employee'),
(2, 'Robert Bailey', '628 Main St, Montreal', 'SSN', '639-90-4450', 'Employee'),
(2, 'Brenda Acevedo', '748 Main St, Montreal', 'SSN', '602-14-8901', 'Employee'),
(3, 'Allison Alvarez', '269 Main St, Edmonton', 'SSN', '377-91-4551', 'Manager'),
(3, 'Jacqueline Dominguez', '476 Main St, Edmonton', 'SIN', '427-73-9608', 'Employee'),
(3, 'Amanda Carter', '617 Main St, Edmonton', 'SSN', '719-25-5407', 'Employee'),
(3, 'Tim Webb', '845 Main St, Edmonton', 'SIN', '556-48-1681', 'Employee'),
(3, 'David Mayo', '585 Main St, Edmonton', 'SIN', '838-93-3834', 'Employee'),
(4, 'Donald Keith', '609 Main St, Edmonton', 'SIN', '448-77-7712', 'Manager'),
(4, 'Christopher Jones', '354 Main St, Edmonton', 'SSN', '340-72-5008', 'Employee'),
(4, 'Julie Ellis', '797 Main St, Edmonton', 'SIN', '535-68-5415', 'Employee'),
(5, 'Laura Wells', '158 Main St, San Francisco', 'SIN', '948-91-2430', 'Manager'),
(5, 'Andrew Sanchez', '983 Main St, San Francisco', 'SSN', '626-73-5934', 'Employee'),
(5, 'Steven Woods', '916 Main St, San Francisco', 'SIN', '224-72-3772', 'Employee'),
(5, 'Leroy Lane', '908 Main St, San Francisco', 'SSN', '370-28-2156', 'Employee'),
(6, 'Joe Cook', '747 Main St, Vancouver', 'SSN', '318-46-7101', 'Manager'),
(6, 'Lisa Smith', '916 Main St, Vancouver', 'SIN', '704-71-6505', 'Employee'),
(6, 'Maria King', '225 Main St, Vancouver', 'SSN', '499-49-8204', 'Employee'),
(6, 'Cynthia Lindsey', '630 Main St, Vancouver', 'SIN', '787-35-8371', 'Employee'),
(6, 'Beverly Sexton', '575 Main St, Vancouver', 'SSN', '913-15-6044', 'Employee'),
(7, 'Kathy Phillips', '248 Main St, Seattle', 'SIN', '682-49-4015', 'Manager'),
(7, 'Brandon Moody', '666 Main St, Seattle', 'SIN', '998-64-1623', 'Employee'),
(7, 'Jimmy Bailey', '231 Main St, Seattle', 'SIN', '389-13-4240', 'Employee'),
(8, 'Donald Jordan', '192 Main St, New York', 'SSN', '480-61-4341', 'Manager'),
(8, 'Carlos Smith', '596 Main St, New York', 'SIN', '687-49-4528', 'Employee'),
(8, 'Doris Wright', '552 Main St, New York', 'SSN', '111-53-9921', 'Employee'),
(8, 'Gregory Roberts', '693 Main St, New York', 'SSN', '177-49-9809', 'Employee'),
(9, 'Cheryl Smith', '333 Main St, Ottawa', 'SSN', '643-40-4033', 'Manager'),
(9, 'Emily Reyes', '566 Main St, Ottawa', 'SIN', '933-91-1972', 'Employee'),
(9, 'Angelica Butler', '901 Main St, Ottawa', 'SIN', '501-64-1642', 'Employee'),
(9, 'Nicole Williams', '782 Main St, Ottawa', 'SSN', '708-82-1570', 'Employee'),
(9, 'Phillip Sanders', '786 Main St, Ottawa', 'SIN', '793-13-4560', 'Employee'),
(10, 'David Ruiz', '967 Main St, Seattle', 'SSN', '822-19-9585', 'Manager'),
(10, 'Laura Gray', '637 Main St, Seattle', 'SSN', '587-86-6932', 'Employee'),
(10, 'Michael Peterson', '276 Main St, Seattle', 'SIN', '869-68-4566', 'Employee'),
...
(13, 'Brianna Rodriguez', '154 Main St, Vancouver', 'SSN', '528-96-7254', 'Manager'),
(13, 'Jillian Daniels', '817 Main St, Vancouver', 'SSN', '167-66-6776', 'Employee'),
(13, 'Stephen Best', '537 Main St, Vancouver', 'SSN', '897-67-6838', 'Employee'),
(14, 'Sarah Nguyen', '713 Main St, Chicago', 'SIN', '602-87-9164', 'Manager'),
(14, 'Tammy Schmitt', '824 Main St, Chicago', 'SIN', '812-39-6402', 'Employee'),
(14, 'Edwin Brown', '648 Main St, Chicago', 'SIN', '206-24-7424', 'Employee'),
(14, 'Meredith Murphy', '390 Main St, Chicago', 'SIN', '888-19-5400', 'Employee'),
(15, 'Ashley Molina', '962 Main St, Las Vegas', 'SIN', '824-23-3280', 'Manager'),
(15, 'Dawn Flynn', '851 Main St, Las Vegas', 'SIN', '870-44-5181', 'Employee'),
(15, 'Carrie Sampson', '138 Main St, Las Vegas', 'SSN', '725-87-5108', 'Employee'),
(15, 'Stephen Harris', '337 Main St, Las Vegas', 'SSN', '356-23-2988', 'Employee'),
(15, 'Diana Fletcher', '433 Main St, Las Vegas', 'SSN', '380-40-2380', 'Employee'),
...
(17, 'Cindy Warner', '945 Main St, Calgary', 'SSN', '961-85-4265', 'Manager'),
(17, 'Jessica Anderson', '384 Main St, Calgary', 'SSN', '259-76-3780', 'Employee'),
(17, 'Ashley Garcia', '761 Main St, Calgary', 'SSN', '749-51-8308', 'Employee'),
(17, 'Emily Bailey', '906 Main St, Calgary', 'SIN', '924-27-9907', 'Employee'),
(18, 'Todd Cervantes', '155 Main St, Edmonton', 'SSN', '781-68-7096', 'Manager'),
(18, 'Nicole Cruz', '477 Main St, Edmonton', 'SIN', '728-97-7664', 'Employee'),
(18, 'Ms. Ashlee Morris', '694 Main St, Edmonton', 'SSN', '215-84-8422', 'Employee'),
(18, 'Tiffany Green', '812 Main St, Edmonton', 'SIN', '570-50-7207', 'Employee'),
(18, 'Katie Clements', '476 Main St, Edmonton', 'SIN', '864-22-1598', 'Employee'),
(19, 'Grant Thompson', '808 Main St, Montreal', 'SSN', '816-49-9190', 'Manager'),
(19, 'Krystal York', '921 Main St, Montreal', 'SSN', '616-65-4288', 'Employee'),
(19, 'Amanda Williams', '636 Main St, Montreal', 'SIN', '859-52-6230', 'Employee'),
(20, 'Joseph Parsons', '108 Main St, Halifax', 'SSN', '764-71-4617', 'Manager'),
(20, 'Jennifer Levy', '867 Main St, Halifax', 'SSN', '531-40-7712', 'Employee'),
(20, 'Jason Adams', '684 Main St, Halifax', 'SSN', '780-27-2697', 'Employee'),
(20, 'Joann Davis', '821 Main St, Halifax', 'SIN', '753-94-7873', 'Employee'),
(21, 'Scott Valenzuela', '704 Main St, Ottawa', 'SIN', '974-60-8571', 'Manager'),
(21, 'Matthew Richard', '787 Main St, Ottawa', 'SIN', '428-88-6167', 'Employee'),
(21, 'Melissa Neal', '367 Main St, Ottawa', 'SIN', '527-88-3162', 'Employee'),
(21, 'Matthew Gonzalez', '702 Main St, Ottawa', 'SIN', '309-33-5424', 'Employee'),
(21, 'Ana Smith', '475 Main St, Ottawa', 'SIN', '175-18-7605', 'Employee'),
(22, 'David Reyes', '329 Main St, Edmonton', 'SIN', '896-26-4860', 'Manager'),
(22, 'Robert Ritter', '900 Main St, Edmonton', 'SIN', '209-45-2092', 'Employee'),
(22, 'Teresa Livingston', '878 Main St, Edmonton', 'SIN', '597-15-4254', 'Employee'),
(23, 'David Kane', '672 Main St, New York', 'SIN', '894-99-2475', 'Manager'),
(23, 'Sara Ruiz', '855 Main St, New York', 'SSN', '442-19-7662', 'Employee'),
(23, 'Jessica Phelps', '611 Main St, New York', 'SIN', '283-45-1373', 'Employee'),
(23, 'Patricia Rivera', '378 Main St, New York', 'SIN', '752-39-1982', 'Employee'),
(24, 'Renee Lane MD', '937 Main St, Calgary', 'SIN', '290-47-9440', 'Manager'),
(24, 'Jeffery Griffith', '749 Main St, Calgary', 'SSN', '940-34-6946', 'Employee'),
(24, 'Jason Hill', '846 Main St, Calgary', 'SIN', '982-55-3229', 'Employee'),
(24, 'Stephanie Cooke', '919 Main St, Calgary', 'SSN', '936-49-8364', 'Employee'),
(24, 'Laura Espinoza', '204 Main St, Calgary', 'SIN', '618-61-4739', 'Employee'),
(25, 'Denise Goodman', '874 Main St, San Francisco', 'SSN', '109-36-4451', 'Manager'),
(25, 'Lisa Patton', '586 Main St, San Francisco', 'SIN', '861-46-8445', 'Employee'),
(25, 'Brittney Snyder', '985 Main St, San Francisco', 'SSN', '462-74-7171', 'Employee'),
(26, 'Marilyn Ochoa', '229 Main St, Edmonton', 'SIN', '670-75-6956', 'Manager'),
(26, 'Brian Flores', '613 Main St, Edmonton', 'SSN', '438-75-6489', 'Employee'),
(26, 'Laura Cain', '801 Main St, Edmonton', 'SIN', '513-25-1130', 'Employee'),
(26, 'Scott Pacheco', '966 Main St, Edmonton', 'SSN', '908-10-6668', 'Employee'),
(27, 'David Wall', '541 Main St, Miami', 'SSN', '194-92-3039', 'Manager'),
(27, 'Richard Garner', '446 Main St, Miami', 'SIN', '870-80-5473', 'Employee'),
(27, 'Brandon Mcdonald', '735 Main St, Miami', 'SIN', '328-76-5472', 'Employee'),
(27, 'Michael Campbell', '277 Main St, Miami', 'SSN', '929-39-3180', 'Employee'),
(27, 'David Smith', '575 Main St, Miami', 'SIN', '433-74-2053', 'Employee'),
(28, 'Mackenzie Lee', '999 Main St, Ottawa', 'SSN', '617-24-7587', 'Manager'),
(28, 'Jorge Jones', '891 Main St, Ottawa', 'SSN', '220-49-4127', 'Employee'),
(28, 'Debbie Cox', '140 Main St, Ottawa', 'SIN', '123-49-3574', 'Employee'),
(29, 'Carolyn Hernandez', '923 Main St, Vancouver', 'SSN', '213-66-5188', 'Manager'),
(29, 'Erica Fitzgerald', '857 Main St, Vancouver', 'SSN', '119-34-8895', 'Employee'),
(29, 'Betty Santiago', '687 Main St, Vancouver', 'SSN', '166-76-4109', 'Employee'),
(29, 'Thomas Good', '259 Main St, Vancouver', 'SIN', '169-74-3574', 'Employee'),
(30, 'Robert Pearson', '422 Main St, Las Vegas', 'SIN', '282-94-7073', 'Manager'),
(30, 'Michelle Henry', '130 Main St, Las Vegas', 'SIN', '217-42-5243', 'Employee'),
(30, 'Stephanie Meyer', '137 Main St, Las Vegas', 'SIN', '657-18-5420', 'Employee'),
(30, 'Cassandra Rogers', '576 Main St, Las Vegas', 'SIN', '143-16-3482', 'Employee'),
(30, 'Vicki Sweeney', '739 Main St, Las Vegas', 'SIN', '641-49-5722', 'Employee'),
(31, 'Stephen Rodriguez', '691 Main St, Las Vegas', 'SSN', '635-68-4735', 'Manager'),
(31, 'Tyler Estrada', '775 Main St, Las Vegas', 'SIN', '910-25-9718', 'Employee'),
(31, 'Kevin Brown', '824 Main St, Las Vegas', 'SIN', '782-46-5428', 'Employee'),
(32, 'Jodi Shepherd', '672 Main St, Edmonton', 'SSN', '498-35-9092', 'Manager'),
(32, 'Alicia Fitzpatrick', '946 Main St, Edmonton', 'SSN', '616-23-9701', 'Employee'),
(32, 'Jacqueline Clark', '553 Main St, Edmonton', 'SSN', '855-19-1269', 'Employee'),
(32, 'Laura Davis', '498 Main St, Edmonton', 'SIN', '167-18-5470', 'Employee'),
(33, 'Robin Phillips', '240 Main St, Boston', 'SSN', '877-51-6451', 'Manager'),
(33, 'Deborah Ortiz DDS', '210 Main St, Boston', 'SIN', '178-97-6747', 'Employee'),
(33, 'Jonathan Lopez', '456 Main St, Boston', 'SIN', '887-10-7994', 'Employee'),
(33, 'Adrian Bennett', '675 Main St, Boston', 'SSN', '166-92-6260', 'Employee'),
(33, 'Susan Hess', '980 Main St, Boston', 'SIN', '478-38-2299', 'Employee'),
(34, 'Sara Price', '118 Main St, Vancouver', 'SIN', '828-87-2676', 'Manager'),
(34, 'Jade Crane', '679 Main St, Vancouver', 'SIN', '482-48-4979', 'Employee'),
(34, 'Angel Howard', '148 Main St, Vancouver', 'SSN', '872-23-1860', 'Employee'),
(35, 'Debbie Holmes', '621 Main St, Seattle', 'SSN', '985-81-8268', 'Manager'),
(35, 'Emily Bridges', '201 Main St, Seattle', 'SIN', '146-50-7531', 'Employee'),
(35, 'Edward Leon', '365 Main St, Seattle', 'SIN', '754-70-3325', 'Employee'),
(35, 'Shannon Harrison', '411 Main St, Seattle', 'SSN', '242-37-9957', 'Employee'),
(36, 'Mary Stewart', '165 Main St, Chicago', 'SIN', '359-18-6730', 'Manager'),
(36, 'Kyle Johnson', '547 Main St, Chicago', 'SIN', '896-74-1327', 'Employee'),
(36, 'Jesus Alvarez', '781 Main St, Chicago', 'SSN', '909-71-1792', 'Employee'),
(36, 'David Lloyd', '521 Main St, Chicago', 'SSN', '897-18-5932', 'Employee'),
(36, 'Travis Aguirre', '197 Main St, Chicago', 'SIN', '404-40-9888', 'Employee'),
(37, 'William Nguyen', '459 Main St, Miami', 'SSN', '550-98-1430', 'Manager'),
(37, 'Christopher Martinez', '688 Main St, Miami', 'SSN', '598-86-7178', 'Employee'),
(37, 'Heidi Ross', '637 Main St, Miami', 'SIN', '715-91-1236', 'Employee'),
(38, 'Mr. Gary Hoffman Jr.', '324 Main St, Montreal', 'SIN', '801-76-4486', 'Manager'),
(38, 'Martin Bradford', '803 Main St, Montreal', 'SSN', '389-78-4782', 'Employee'),
(38, 'Deborah Castillo', '853 Main St, Montreal', 'SIN', '642-95-4174', 'Employee'),
(38, 'Sabrina Taylor', '340 Main St, Montreal', 'SIN', '593-88-2520', 'Employee'),
(39, 'Michelle Ramos', '145 Main St, Chicago', 'SSN', '174-78-8247', 'Manager'),
(39, 'Thomas Fisher', '573 Main St, Chicago', 'SIN', '428-57-4145', 'Employee'),
(39, 'Danny Smith', '220 Main St, Chicago', 'SIN', '602-96-9051', 'Employee'),
(39, 'Tonya Reed', '318 Main St, Chicago', 'SSN', '200-39-6784', 'Employee'),
(39, 'Austin Martinez', '195 Main St, Chicago', 'SIN', '285-91-8272', 'Employee'),
(40, 'Nathan Thomas', '659 Main St, Miami', 'SIN', '259-28-7855', 'Manager'),
(40, 'Samantha Anderson', '175 Main St, Miami', 'SSN', '615-28-7810', 'Employee'),
(40, 'Jonathan Rodriguez', '648 Main St, Miami', 'SSN', '315-66-5406', 'Employee');
